...
namespace Uc11RetriveAllRecordWhoGiveGod
{
    class Program
    {
        ...
        public static void CreateDataTable()
        {
            ...
            RetrieveDataablesWhoseReviewValueIsGood(table);
        ...
        //    var result = (from product in table.AsEnumerable().Where(p => p("Rating") != DBNull.Value).Select(c => Convert.ToDecimal(c("Rating")).Average();
        ...
        public static void RetrieveDataablesWhoseReviewValueIsGood(DataTable table)
        {
